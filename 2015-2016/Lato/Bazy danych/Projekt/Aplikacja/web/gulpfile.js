...
gulp.task('webserver', function () {
    return gulp.src(config.webserver.dest)
        .pipe(gulpWebserver({
            ...
            proxies: [
                {source: '/api/user/', target: config.webserver.apiUrl + '/usser/'},
                {source: '/api/login/', target: config.webserver.apiUrl + '/login/'},
                {source: '/api/logout/', target: config.webserver.apiUrl + '/logout/'},
                {source: '/api/station/', target: config.webserver.apiUrl + '/station/'},
                {source: '/api/service/', target: config.webserver.apiUrl + '/service/'},
                {source: '/api/rent/', target: config.webserver.apiUrl + '/rent/'},
                {source: '/api/bike/', target: config.webserver.apiUrl + '/bike/'}
            ]
        }));
});
